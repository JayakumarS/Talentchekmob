...
//
  ...
  startTour(){
    ...
    const driverObj = driver({
      showProgress: true,
      steps: [
        { element: '#step1', popover: { title: 'Profile Lookup', description: 'You can search and view profiles here.', side: "top",
          align: 'end'} },
        { element: '#step2', popover: { title: 'Job Search', description: 'Add your preferences here to get matched with right opportunities.', side: "top",
          align: 'end' } },
        { element: '#step3', popover: { title: 'Profile', description: 'Update your professional portfolio over here and get your claims verified.', side: "top",
          align: 'end' } },
        { element: '#step4', popover: { title: 'More', description: 'Discover Alumni profiles, manage subscriptions and other settings over here.', side: "top",
          align: 'end' } },
      ]
    });
